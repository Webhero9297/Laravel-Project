        ...
        <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer" id="sample_1" role="grid" aria-describedby="sample_1_info">
            ...
            <tbody id='data_area'>
                ...
                <tr class="gradeX odd" role="row">
                    ...
                    <td align=center>
                        <button class="view_user btn blue btn-outline sbold" type="button" user_id="{{ $user->id }}" onclick="doOnViewDetail(this)">View ID information
                        </button>
                    </td>
                </tr>
                @endforeach
...
function doOnViewDetail(thisObj) {
    ...
    window.location.href = '/useriddetail/'+userId;
    window.reload();
}
</script>
@endsection